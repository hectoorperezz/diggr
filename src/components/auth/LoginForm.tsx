...
function LoginFormContent() {
  ...
  const { signIn, signInWithGoogle, session } = useSupabase();
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Nota: Google redirecciona, así que es posible que esto no sea necesario
      // pero lo incluimos para manejar errores locales
